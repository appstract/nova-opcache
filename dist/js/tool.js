...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__PartitionMetric__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__PartitionMetric___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__PartitionMetric__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        BasePartitionMetric: __WEBPACK_IMPORTED_MODULE_1__PartitionMetric___default.a
    },
    ...
    computed: {
        production: function production() {
            if (this.config.length) {
                if (this.config.directives["opcache.memory_consumption"] >= 128 && this.config.directives["opcache.interned_strings_buffer"] >= 16 && !this.config.directives["opcache.validate_timestamps"]) {
                    return true;
                }
            }
    ...
    methods: {
        getStatus: function getStatus() {
            ...
            Nova.request().get('/nova-vendor/nova-opcache/status').then(function (response) {
...
Component.options.__file = "resources/js/components/PartitionMetric.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1e1106c2", Component.options)
  } else {
    hotAPI.reload("data-v-1e1106c2", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_chartist__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_chartist_dist_chartist_min_css__ = __webpack_require__(19);
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("h3", { staticClass: "flex mb-3 text-base text-white font-bold" }, [
        _vm._v("\n    " + _vm._s(_vm.title) + "\n\n    "),
      ...
      _vm.helpText
        ? _c(
            "div",
            { staticClass: "absolute pin-r pin-b p-2" },
            [
              _c(
                "tooltip",
                { attrs: { trigger: "hover" } },
      ...
      _c("div", { staticClass: "overflow-hidden overflow-y-auto max-h-90px" }, [
        _c(
          ...
          _vm._l(_vm.formattedItems, function(item) {
            return _c(
              "li",
              { staticClass: "text-xs text-white leading-normal" },
              [
                _c("span", {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1e1106c2", module.exports)
  }
}
  ...
  return _c("div", { staticClass: "bg-gray-900" }, [
    ...
    _c(
      ...
      [
        _c(
          "div",
          { staticClass: "flex flex-col w-1/3 m-2" },
          [
            _c(
              "card",
              ...
              [
                ...
                _c("p", { staticClass: "mb-2 ml-4" }, [
                  _vm._v("Hits: "),
                  _c("strong", [
                    _vm._v(_vm._s(_vm.status.opcache_statistics.hits))
                  ])
                ]),
                _vm._v(" "),
                _c("p", { staticClass: "mb-2 ml-4" }, [
            ...
            _c(
              "card",
              { staticClass: "w-full mt-4 p-4 bg-black text-white" },
              [
                _c("heading", { staticClass: "text-white mb-4" }, [
                  _vm._v(
                    "\n                        Status\n                    "
                ...
                _c("p", { staticClass: "mb-2 ml-4" }, [
                  ...
                  _c("strong", [
                    _vm._v(
                      _vm._s(new Date(_vm.status.opcache_statistics.start_time))
                    )
                  ])
                ]),
                _vm._v(" "),
                ...
                _c("p", { staticClass: "mb-2 ml-4" }, [
                  _vm._v("Oom restarts: "),
                  _c("strong", [
                    _vm._v(_vm._s(_vm.status.opcache_statistics.oom_restarts))
                  ])
                ]),
                _vm._v(" "),
                _c("p", { staticClass: "mb-2 ml-4" }, [
                  ...
                  _c("strong", [
                    _vm._v(_vm._s(_vm.status.opcache_statistics.hash_restarts))
                  ])
                ]),
                _vm._v(" "),
                _c("p", { staticClass: "mb-2 ml-4" }, [
                  ...
                  _c("strong", [
                    _vm._v(
                      _vm._s(_vm.status.opcache_statistics.manual_restarts)
                    )
                  ])
                ])
              ],
